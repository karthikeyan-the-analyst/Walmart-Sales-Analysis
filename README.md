...
1. Wgat are the unique product lines does the data have?
...
For the rest of the code, check the [SQL_queries.sql](https://github.com/karthikeyan-the-analyst/Walmart-Sales-Analysis-/blob/main/Walmart%20SQL%20queries.sql) file
